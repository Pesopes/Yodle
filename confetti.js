...
(function() {
	...
	var colors = ["#e25a61", "DodgerBlue", "OliveDrab", "Gold", "Pink", "SlateBlue", "LightBlue", "Violet", "PaleGreen", "SteelBlue", "SandyBrown", "Chocolate", "Crimson"]
	...
	function startConfettiInner() {
		...
		if (canvas === null) {
			...
			canvas.setAttribute("style", `display:block;z-index:${999999 * (zIndexPosition ? 1:-1)};pointer-events:none;position:absolute;top:0%`);
